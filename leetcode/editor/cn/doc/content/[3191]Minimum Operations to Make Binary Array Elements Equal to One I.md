...
<p><strong>Explanation:</strong><br /> We can do the following operations:</p>
...
<p><strong>Explanation:</strong><br /> It is impossible to make all elements equal to 1.</p>
...
<div><div>Related Topics</div><div><li>位运算</li><li>队列</li><li>数组</li><li>前缀和</li><li>滑动窗口</li></div></div><br><div><li>👍 0</li><li>👎 0</li></div>